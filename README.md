...
The backend math version is `abyssinia-97-hit10-cap200-v3`:

| Setting | Value |
| --- | --- |
| Theoretical RTP | 97% |
| Positive-payout paid rounds | 10% |
| Zero-payout paid rounds | 90% |
| Maximum complete-round payout | 200× the bet |
| Bet range | ETB 4–4,000 |

The 10-million-round simulation returned 96.989535% RTP and a 10.00705%
positive-payout rate. A positive payout includes a return below the stake;
free spins and respins are included in their originating paid round.
